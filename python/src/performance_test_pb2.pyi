...
class TestRequest(_message.Message):
    __slots__ = ("request_id", "timestamp", "payload_size", "payload", "metadata")
    ...
    def __init__(self, request_id: _Optional[str] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., payload_size: _Optional[_Union[PayloadSize, str]] = ..., payload: _Optional[bytes] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class TestResponse(_message.Message):
    ...
    payload: bytes
    def __init__(self, request_id: _Optional[str] = ..., received_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., processed_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., metrics: _Optional[_Union[ProcessingMetrics, _Mapping]] = ..., payload: _Optional[bytes] = ...) -> None: ...

class StreamRequest(_message.Message):
    __slots__ = ("message_count", "payload_size", "interval_ms")
    ...
    payload_size: PayloadSize
    interval_ms: int
    def __init__(self, message_count: _Optional[int] = ..., payload_size: _Optional[_Union[PayloadSize, str]] = ..., interval_ms: _Optional[int] = ...) -> None: ...
